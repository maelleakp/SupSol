                ...
                <legend>INSCRIPTION</legend>
                    <form action="../Controller/controller.php" method="POST" id="myForm">
                        <p>
                            ...
                            <input type="text" id="nom" name="nom" size="15" placeholder="Écrivez ici" required>
                            <span id="errorName"></span>
                        </p>
    
                        <p>
                            <label for="prenom">Votre prénom :</label>
                            <input type="text" id="prenom" name="prenom" size="15" required autofocus>
                        ...
                        <p>
                            ...
                            <input type="tel" id="tel" name="tel" placeholder="Exemple +33 6 XX XX XX XX pour la France" size="15" required>
                        </p>
                        ...
                        <p>
                            ...
                            <input type="password" id="password2" name="password2" size="15" onkeyup="checkPass(); return false">
                            <span id="errorPassword2"></span>
                        </p>
                        <hr>
                        <p>
                            <input type="checkbox" required>
                            Écrire règles de consentement RGPD
                        </p>
                        <hr>
                        <p>
            ...
            <fieldset id="groupe">
                <legend>CONNEXION</legend>
                    <form action="../Controller/controller.php" method="POST" id="Form">
                        <p>
                            <label for="email">Votre email :</label>
                            <input type="email" id="mail2" name="mail" size="15" required>
                            <span id="errorMail2"></span>
                        </p>
    
                        <p>
                            <label for="mdp">Votre mot de passe :</label>
                            <input type="password" id="password3" name="password" size="15">
