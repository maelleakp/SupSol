...
<html lang="en-EN">
    ...
    <header>
        ...
        <h2>Participer au tirage au sort pour tenter de remporter un mailllt dédicacé</h2>

        <section id="concours">
                <form action="../Controller/afficheAnglais.php" method="POST" id="participe">
                        <table>                                
                            ...
                            <tr>
                                ...
                                <td><?php $idM = $affiche[$i]->ID_M_Rencontre?>
                                    <input type="submit" name="submit[<?php echo $idM ?>]" value="I participate">
                                </td>  
                                <?php } ?>                                                      
                            </tr>
                            <?php endfor; ?>
